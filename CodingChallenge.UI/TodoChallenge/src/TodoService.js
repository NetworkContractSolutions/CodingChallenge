...
const svc = {
  getTodos: () => {
    ...
    return Promise.resolve(parsed.map(todo => todo.dueDate ? { ...todo, dueDate: new Date(todo.dueDate) } : todo));
  },
  ...
  addTodo: async (newTodo) => {
    ...
    const todo = { id: nextId, text: newTodo.text, isComplete: false, dueDate: newTodo.dueDate };
